...
function createtime() {
  ...
  var start = new Date("09/11/2023 00:00:00"); // 旅行者1号开始计算的时间
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ...
      : `<img class='boardsign' src='https://lskypro.acozycotage.net/Fomalhaut/badge/F小屋-科研摸鱼中.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    ...
    --darkmode-bg: url(https://source.fomal.cc/img/default_cover_16.webp);
    --mobileday-bg: url(https://source.fomal.cc/img/default_cover_14.webp);
    --mobilenight-bg: url(https://source.fomal.cc/img/default_cover_12.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
